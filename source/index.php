    ...
    <div class="wrapper">
        <div class="animated-bg">
            <div class="container fluid">
                ...
                <div class="row tile-row">
                    <div class="col-md-12 text-center">
                        <a class="btn btn-lg btn-default btn-primary" href="sonification.php"><h4>Let's Sonify my data now</h4></a><br/>
                    </div>
                </div>
                <div class="row text-center">
                    <div class="col-md-12">
                        <h3>Additional sources</h3>
                        <p><li><a href="http://www.icad.org">icad.org</a></li></p>
                        <p><li><a href="http://www.sonification.de">sonification.de</a></li></p>
                        </ul>
                    </div>    
                </div>
            </div>
